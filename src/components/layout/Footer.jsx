    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">SecureVoteChain</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/voter/dashboard" className="text-gray-400 hover:text-white text-sm">Voter Dashboard</Link></li>
              <li><Link to="/voter/results" className="text-gray-400 hover:text-white text-sm">Election Results</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.7 3H4.3A1.3 1.3 0 003 4.3v15.4A1.3 1.3 0 004.3 21h15.4a1.3 1.3 0 001.3-1.3V4.3A1.3 1.3 0 0019.7 3zM8.339 18.338H5.667v-8.59h2.672v8.59zM7.004 8.574a1.548 1.548 0 11-3.096 0 1.548 1.548 0 013.096 0zM18.338 18.338h-2.669V14.17c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.238h-2.667v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.779 3.203 4.092v4.71z" />
                </svg>
              </a>
            </div>
            <p className="text-gray-400 mt-4 text-sm">
              © {currentYear} SecureVoteChain. All rights reserved.
            </p>
          </div>
        </div>
      </div>
